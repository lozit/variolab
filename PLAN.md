...
- [~] **v0.18.0 — uninstall data safeguard + upgrade warning.** Built + verified locally (PHPCS clean, 114 unit + 51 integration green), committed (`52ce25a`). **Awaiting user "go" to release** (push `main` + tag → CI / Release / wp.org deploy).
